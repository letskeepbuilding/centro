...
if(isset($_POST['submit'])) {
	...
	$checkbox2=$_POST['ReasonVisitCall']; 
	$chk2="";  
	...
	$query  = "INSERT INTO `followupCALSurvey` SET user_id=?,Supervisor=?,Company=?,stillEmployed=?,WhyNotEmployed=?,StartingWage=?,wageNow=?,hoursWeek=?,jobType=?,adequatelyTrain=?,additionalComments=?";
	$parameters = array($user_id,$_POST['Supervisor'],$_POST['Company'],$_POST['stillEmployed'],$_POST['WhyNotEmployed'],$_POST['StartingWage'],$_POST['wageNow'],$_POST['hoursWeek'],$_POST['jobType'],$_POST['adequatelyTrain'],$_POST['additionalComments']);
					...
					<div class="portlet">
						...
						<div class="portlet-content">
			    			...
			    			<div class="row">
			    				...
			    				<div class="col-xs-12 col-sm-6 col-md-6">
			    					<div class="form-group">
              							<input type="text" name="Company" placeholder="Company/Organization Name" class="form-control">
			    					</div>
			    				</div>
			    			</div>
			    			<div class="row">
								<div class="col-xs-12 col-sm-12 col-md-12">
									...
									<label class="radio-inline"><input type="radio" class="WhyNotEmployed" name="stillEmployed" value="Yes">Yes</label>
									<label class="radio-inline"><input type="radio" class="WhyNotEmployed" name="stillEmployed" value="No">No</label>
									</div>
								</div>
			    			</div>
			    			...
			    			<div class="row">
								<div class="col-xs-12 col-sm-8 col-md-8">
									...
									<label class="radio-inline"><input type="radio" name="jobType" value="Seasonal">Seasonal</label>
									<label class="radio-inline"><input type="radio" name="jobType" value="Temporary">Temporary</label>
									<label class="radio-inline"><input type="radio" name="jobType" value="Permanent">Permanent</label>
									</div>
								</div>
			    			</div>
			    			<div class="row">
			    			...
			    			<div class="row">
								<div class="col-xs-12 col-sm-12 col-md-12">
			    					<div class="form-group">
			    						  ...
			    						  <textarea class="form-control" rows="5" id="additionalComments"></textarea>
			    					</div>
			    				</div>
			    			</div>
			    			<div class="row">
