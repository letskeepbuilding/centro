...
session_start();
        ...
        $userData = $db->prepare("SELECT * FROM admin");
        $userData->execute();
...
<script>
   ...
   var table=     $('#userTable').dataTable( {
            ...
            "sServerMethod": "GET",
            "aaSorting": [[ 0, "desc" ]],
            "sAjaxSource": "code/ajaxAdminView2.php",
            "aoColumns": [
            ...
            "fnRowCallback": function( nRow, aData, iDisplayIndex ) {
                ...
                $(row.find("td")['7']).html(
                    '<a type="button" href="edit_admin.php?id='+userID+'" class="btn btn-info btn-xs">	<i class="fa fa-edit"></i></a>&nbsp;<a href="javascript:;" onclick="del(\''+aData['7']+'\',\''+aData['1']+'\')" class="btn btn-primary btn-xs">	<i class="fa fa-trash-o"></i></a>'
                );
            }
