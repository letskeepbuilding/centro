 ...
 */
$aColumns = array( 'id','name', 'lastname', 'address','created_at', 'status','id' );
$asColumns = array( 'id','name', 'lastname', 'address','created_at', 'status','id' );
$aaColumns = array( 'id','name', 'lastname', 'address','created_at', 'status','id');
