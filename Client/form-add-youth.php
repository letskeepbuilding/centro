...
if(isset($_POST['submit'])) {
	$query  = "INSERT INTO `youth` SET name=?,middlename=?,lastname=?,address=?,apt=?,city=?,state=?,zip=?,email=?,phone_home=?,phone_cell=?,ethnicity=?,DOB=?,Age=?,status=?";
...
<div id="content-container" class="container" style="margin-top:20px">
	<h2 style="text-align:center">Add Youth</h2>
	<hr />
