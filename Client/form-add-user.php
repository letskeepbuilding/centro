...
<div id="content-container" class="container" style="margin-top:20px">
	<h2 style="text-align:center">Basic Intake<br /><br /><div id="google_translate_element"></div><script type="text/javascript">
		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-4 col-md-4">
				<div class="form-group has-feedback">
					...
					<select class="form-control" id="state" name="state" required="" data-error="State is required." data-parsley-trigger="focusin focusout">
	...
	<div class="row">
		<div class="col-xs-12 col-sm-6 col-md-6">
			<div class="form-group">
				...
				<input type="text" name="phone_home" id="phone_home" class="form-control" placeholder="(xxx) xxx-xxxx"  data-parsley-trigger="focusin focusout">
			</div>
		</div>
		<div class="col-xs-12 col-sm-6 col-md-6">
			<div class="form-group">
				<label for="phone_cell" class="control-label">Phone (Cell)</label>
				<input type="text" name="phone_cell" id="phone_cell" class="form-control" placeholder="(xxx) xxx-xxxx" data-parsley-trigger="focusin focusout">
			</div>
		</div>
	</div>
